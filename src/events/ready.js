module.exports = async (client) => {
  ...
  for (const guild of leftGuilds) {
    ...
    client.logger.info(`Leunelbot has left ${guild.guild_name}`);
  }

  client.logger.info('Leunelbot is now online');
  client.logger.info(`Leunelbot is running on ${client.guilds.cache.size} server(s)`);
};
