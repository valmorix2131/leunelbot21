...
module.exports = class BotInfoCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      aliases: ['bot', 'bi'],
      usage: 'botinfo',
      description: 'Fetches LeunelBot\'s bot information.',
  ...
  run(message) {
    ...
    const embed = new MessageEmbed()
      .setTitle('LeunelBot\'s Bot Information')
      .setDescription(oneLine`
        LeunelBot is a new fully customizable Discord bot that is constantly growing.
        ...
        She first went live on **March 26 2021**.
      `)
      ...
      .addField(
        ...
        '[Support Server](https://discord.gg/a98v3fCTM7) | ' +
        '**'
      )
