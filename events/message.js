    ...
    if (command && !disabledCommands.includes(command.name)) {
      ...
      if (modChannelIds.includes(message.channel.id)) {
        if (
          ...
          return; // Return early so LeunelBot doesn't respond
        }
      }
      ...
      const embed = new MessageEmbed()
        .setTitle('Hi, I\'m LeunelBot. Need help?')
        .setThumbnail('LB.jpg')
        ...
        .addField('Support', oneLine`
          ...
          [Leunelbot Support Server](https://discord.gg/a98v3fCTM7)!
        `)
        .setFooter('DM Leunel#2393 to speak directly with the developer!')
